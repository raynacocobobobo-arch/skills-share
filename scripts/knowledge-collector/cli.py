...
from providers.youtube.youtube_provider import build_metadata, get_latest_video
...
def collect(watchlist, limit_sources=1):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit-sources", type=int, default=1)
    args = parser.parse_args()

    print(collect(load_watchlist(args.watchlist), limit_sources=args.limit_sources))
